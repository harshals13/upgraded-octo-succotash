(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LocationService = /** @class */ (function () {
                ...
                LocationService.prototype.addLocation = function (data) {
                ...
                LocationService.prototype.updateLocation = function (data) {
                    var responseType = 'json';
                    this.options = {
                        responseType: responseType
                    };
                ...
                LocationService.prototype.getLocationsForUser = function (userId) {
                    var responseType = 'json';
                    this.options = {
                        responseType: responseType
                    };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LocationdetailsComponent = /** @class */ (function () {
                function LocationdetailsComponent(locationService, route, router) {
                ...
                LocationdetailsComponent.prototype.getLocationDetails = function () {
                    var _this = this;
                    this.locationService.getLocationDetails(this.id).subscribe(function (res) {
                        _this.location = res.response;
                    });
                };
                LocationdetailsComponent.prototype.deleteLocation = function () {
                    var _this = this;
                    this.locationService.deleteLocation(this.id).subscribe(function (res) {
            ...
            LocationdetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LocationlistComponent = /** @class */ (function () {
                function LocationlistComponent(modalService, locationService, router) {
                ...
                LocationlistComponent.prototype.openLocationForm = function (template, location) {
                ...
                LocationlistComponent.prototype.search = function () {
                    var _this = this;
                    this.locationService.search(this.keyword).subscribe(function (res) {
                        _this.locations = res.response;
                    });
                };
                LocationlistComponent.prototype.getAllLocation = function () {
                    var _this = this;
                    this.locationService.getLocationsForUser(localStorage.email).subscribe(function (res) {
                        _this.locations = res.response;
                    });
                };
                LocationlistComponent.prototype.fileUpload = function (event) {
                    this.selectedFile = event.target.files[0];
                };
                LocationlistComponent.prototype.addLocation = function (value) {
                    var _this = this;
                    ...
                    if (this.addLocationForm.valid && this.selectedFile) {
                        ...
                        if (this.isUpdate) {
                            ...
                            this.locationService.updateLocation(formData).subscribe(function (res) {
                                console.log(res);
                                if (res.status === 0) {
                                    _this.modalRef.hide();
                            ...
                            this.locationService.addLocation(formData).subscribe(function (res) {
                                console.log(res);
                                if (res.status === 0) {
                                    _this.modalRef.hide();
                                    _this.getAllLocation();
                ...
                LocationlistComponent.prototype.getLocationDetails = function (locationId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.login = function (value) {
                    var _this = this;
                    this.userService.login(value).subscribe(function (data) {
                        console.log(data);
                        var user = JSON.stringify(data.responde);
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.register = function (value) {
                    ...
                    if (this.registerForm.valid) {
                        this.userService.register(value).subscribe(function (data) {
                            if (data.status === 0) {
